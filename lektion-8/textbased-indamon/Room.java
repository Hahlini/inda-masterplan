...
public class Room {
    ...
    private Indamon opponent;

    /**
     * Create a new room.
     * @param description the description of this room.
     */
    public Room(Indamon opponent, String description) {
    ...
    public void lookAround() {
        ...
        System.out.println("You also see the ferocious indamon " + opponent.getName() + " staring angrily at you, almost urging you to fight it.");
        printExits();
    }

    public boolean fight(Indamon playerIndamon) {
        IndamonFight contest = new IndamonFight(playerIndamon, opponent);
        return contest.fight();
    }
}
...
public class CommandParser {
    ...
    private static void fight(GameState state) {
        boolean playerWonFlag = state.getCurrentRoom().fight(state.getPlayerIndamon());
        if (playerWonFlag) {
            state.setState("won");
        } else {
            state.setState("lost");
    ...
    public static void printHelpMessage() {
        ...
        System.out.println("    \"fight\" - Fight an Indamon");
